...
//   console.log(`사용자 수정 요청: id=${id}, 새 이름=${newName}`);

//   if (users[id]) {
//     users[id] = newName;
//     res.send(`ID ${id}의 이름이 ${newName}으로 수정되었습니다.`);
//   } else {
//     res.status(404).send(`ID ${id}를 가진 사용자가 없습니다.`);
//   }
// });
...
app.listen(port, () => {
  console.log(`서버 준비됨 빨리 요청해라! ${port}`);
});
